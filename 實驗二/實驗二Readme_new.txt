...
6) ./udtserver <server_port> <packet_number> <num_client> <output_interval(sec)>
(p.s. <server_port> : server的port; <packet_number>: 封包傳輸數量;  <num_client> : client的個數; <output_interval(sec)>: 多久印一次資料;
